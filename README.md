# CBS
![test_ubuntu](https://github.com/Kyoto-March/CBS/actions/workflows/test_ubuntu.yml/badge.svg)
![test_macos](https://github.com/Kyoto-March/CBS/actions/workflows/test_macos.yml/badge.svg)
...
- outputPaths: the output file for paths in [mapf-visualizer](https://github.com/Kei18/mapf-visualizer) format
...
This project supports direct output for [mapf-visualizer](https://github.com/Kei18/mapf-visualizer). 
To visualize the planning results:

1. Install [mapf-visualizer](https://github.com/Kei18/mapf-visualizer) following its README instructions.

2. Run the solver with `--outputPaths`:
```shell script
./cbs -m random-32-32-20.map -a random-32-32-20-random-1.scen --outputPaths=paths.txt -k 30 -t 60
```

3. Launch the visualizer:
```shell script
mapf-visualizer random-32-32-20.map paths.txt
```
